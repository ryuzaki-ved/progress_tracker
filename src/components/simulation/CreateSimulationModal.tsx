          ...
          <Card className="bg-gradient-to-br from-purple-50 to-indigo-50 border-purple-200">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h2 className="text-xl font-bold text-purple-900">Create New Simulation</h2>
                  <p className="text-purple-700 text-sm">Design your alternate life strategy</p>
                </div>
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-purple-200 rounded-lg bg-white text-purple-900 placeholder-purple-500 focus:outline-none focus:ring-2 focus:ring-purple-400"
              ...
              <div>
                ...
                <div className="flex space-x-2 mb-3">
                  <input
                    ...
                    className="flex-1 px-3 py-2 border border-purple-200 rounded-lg bg-white text-purple-900 placeholder-purple-500 focus:outline-none focus:ring-2 focus:ring-purple-400"
                  ...
                  <div className="flex flex-wrap gap-2">
                    {formData.tags.map((tag, index) => (
                      <motion.span
                        ...
                        className="inline-flex items-center px-3 py-1 bg-purple-200 text-purple-800 rounded-full text-sm"
                      >
                        {tag}
                        <button
                          type="button"
              ...
              <div className="bg-purple-100 rounded-lg p-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-purple-900 mb-1">What happens next?</h4>
