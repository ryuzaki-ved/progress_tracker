...
import { TrendingUp, TrendingDown, Activity, Target, Award, BookOpen, Plus, BarChart3, Calendar, X } from 'lucide-react';
...
export const Dashboard: React.FC = () => {
      ...
      <div className="p-6 flex items-center justify-center min-h-96">
        <div className="text-center max-w-md mx-auto">
          <motion.div
            ...
            className="w-20 h-20 bg-gradient-to-br from-violet-500 to-indigo-600 rounded-full flex items-center justify-center mx-auto mb-6"
          >
          ...
          >
            <div className="bg-violet-50 dark:bg-violet-900/20 border border-violet-200 dark:border-violet-700 rounded-lg p-4">
              <h3 className="font-semibold text-violet-900 dark:text-violet-100 mb-2">What you'll be able to do:</h3>
            ...
            <motion.a
              href="/stocks"
              className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-700 hover:to-indigo-700 text-white font-semibold rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl"
  ...
  const activeStreaks = streaks.filter((s: any) => s.isActive);
  ...
  return (
    <div className="space-y-6 relative z-0">
      ...
      >
        ...
        <div className="relative z-10 flex items-center justify-between">
          ...
          <motion.div
            ...
            className="text-right bg-white/5 rounded-2xl p-4 backdrop-blur-md border border-white/10"
          >
      ...
      <motion.div
        ...
        className="relative overflow-hidden rounded-3xl bg-surface/80 border border-white/5 p-8 shadow-glass-inset backdrop-blur-2xl"
      >
        ...
        <div className="relative z-10">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex space-x-2 pt-2 border-t border-gray-200 dark:border-gray-600">
                          ...
                          <button
                            ...
                            className="flex-1 px-3 py-2 text-sm bg-violet-600 text-white rounded hover:bg-violet-700"
                          >
                            Clear Range
                          </button>
                        </div>
          ...
          <div className="h-[400px] bg-gradient-to-br from-white/[0.03] to-white/[0.01] backdrop-blur-md rounded-2xl p-6 border border-white/10 shadow-inner">
            <IndexCandlestickChart data={filteredChartData as any} height={350} />
          </div>
        </div>
      </motion.div>
      ...
      >
        <motion.div
          ...
          className="glass-card p-6 relative overflow-hidden group border-emerald-500/30 hover:border-emerald-500/50"
        >
        ...
        <motion.div
          whileHover={{ scale: 1.02, y: -2 }}
          className="glass-card p-6 relative overflow-hidden group border-violet-500/30 hover:border-violet-500/50"
        >
          <div className="absolute inset-0 bg-violet-500/10 group-hover:bg-violet-500/20 transition-colors duration-300"></div>
          <div className="relative z-10 flex items-center justify-between">
            <div>
              <p className="text-xs text-violet-400 font-medium uppercase tracking-wider">Pending Tasks</p>
        ...
        <motion.div
          whileHover={{ scale: 1.02, y: -2 }}
          className="glass-card p-6 relative overflow-hidden group border-amber-500/30 hover:border-amber-500/50"
        >
      ...
      >
        <div className="relative overflow-hidden rounded-3xl bg-surface/50 border border-emerald-500/20 p-6 shadow-glass">
          <div className="absolute inset-0 bg-gradient-to-r from-white/5 to-transparent"></div>
              ...
              {topPerformers.map((stock, index) => (
                ...
                >
                  <div className="flex items-center space-x-3">
                    ...
                    {streaks.filter((s: any) => s.isActive).length > 0 && (
                      <motion.span
                        animate={{ scale: [1, 1.2, 1] }}
        ...
        <div className="relative overflow-hidden rounded-3xl bg-surface/50 border border-rose-500/20 p-6 shadow-glass">
          <div className="absolute inset-0 bg-gradient-to-r from-white/5 to-transparent"></div>
          <div className="absolute top-0 right-0 w-16 h-16 bg-white/5 rounded-full -translate-y-8 translate-x-8"></div>
          <div className="relative z-10">
            <h3 className="text-lg font-bold text-white mb-4 flex items-center">
